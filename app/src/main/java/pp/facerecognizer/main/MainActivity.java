...
package pp.facerecognizer.main;
...
import pp.facerecognizer.CameraActivity;
...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (!initialized) {
            Snackbar.make(getWindow().getDecorView().findViewById(R.id.container), "Try it again later", Snackbar.LENGTH_SHORT).show();
            return;
        }
